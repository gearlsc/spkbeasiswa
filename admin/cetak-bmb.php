...
<h3 align="center">Daftar Penerima Beasiswa Mahasiswa Berprestasi</h3><!-- /.content-header --><!-- /.content-header -->
...
$queri="select * from mahasiswa_bmb order by preferensi desc limit 10" ;  //menampikan SEMUA data dari tabel siswa
